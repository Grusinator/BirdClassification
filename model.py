...
from keras.layers import AtrousConv2D, Conv2D, MaxPool2D, ZeroPadding2D
...
def get_frontend(input_width, input_height) -> Sequential:
    ...
    model.add(Conv2D(64, (3, 3), activation='relu', name='conv1_1', input_shape=(input_width, input_height, 3)))
...
def add_context(model: Sequential) -> Sequential:
    ...
    model.add(Conv2D(168, (3, 3), dilation_rate=(4, 4), activation='relu', name='ct_conv3_1'))
    model.add(Conv2D(336, (3, 3), dilation_rate=(8, 8), activation='relu', name='ct_conv4_1'))
    model.add(Conv2D(672, (3, 3), dilation_rate=(16, 16), activation='relu', name='ct_conv5_1'))
